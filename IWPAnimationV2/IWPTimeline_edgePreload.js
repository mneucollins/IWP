...
if(document.addEventListener ){ 
   ...
   aLoader = [
      ...
      { load: "IWPTimeline_edge.js"},
      { load: "IWPTimeline_edgeActions.js"}];
...
var plSTF="both",ctrPlS="none",minPlW="0",maxPlW=undefined,plWidth="1260px",plHeight="750px";
...
preContent={
    dom: [
    {
        ...
        type: 'image',
        tag: 'img',
        rect: ['570', '315','120px','120px','auto', 'auto'],
