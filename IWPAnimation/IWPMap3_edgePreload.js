...
if(document.addEventListener ){ 
   ...
   aLoader = [
      ...
      { load: "IWPMap3_edge.js"},
      { load: "IWPMap3_edgeActions.js"}];
...
var plSTF="width",ctrPlS="none",minPlW="0",maxPlW=undefined,plWidth="960px",plHeight="560px";
...
preContent={
    dom: [
    {
        ...
        type: 'image',
        tag: 'img',
        rect: ['473px', '298px','51px','26px','auto', 'auto'],
